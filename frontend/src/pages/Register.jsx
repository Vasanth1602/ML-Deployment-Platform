        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="w-full max-w-sm">
                ...
                <div className="bg-card border border-border rounded-2xl p-8 shadow-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-6">Start deploying ML models</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            {/* Strength hint */}
                            {password.length > 0 && (
                                <p className={`mt-1.5 text-xs ${pwdStrong ? 'text-green-500' : 'text-muted-foreground'}`}>
                                    {pwdStrong ? '✓ Strong password' : 'Need 8+ chars, uppercase, number & special char'}
                                </p>
                            )}
                        </div>
